<div class="ebg-br-wrapper %%_WRAPPER_DARK_MODE_%%">
	<img class="ebg-br-header-logo" src="%%_FILE_IMG_ICO_GITHUB_%%" alt="<?php echo esc_html__( 'GitHub Card', 'embed-block-for-github' ); ?>" />
	<div class="ebg-br-avatar"><img class="ebg-br-header-avatar" src="%%_DATA_AVATAR_URL_%%" alt="" width="150" height="150" /></div>
	<div class="ebg-br-main">
		...
		<p class="ebg-br-footer">
			<span class="ebg-br-subscribers">
				<img src="%%_FILE_IMG_SUBSCRIBE_%%" alt="" /> 
