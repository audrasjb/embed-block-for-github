<div class="ebg-br-wrapper">
	<div class="%%_WRAPPER_DARK_THEME_%% ebg-br-template-user">
		<div class="ebg-br-body ebg-br-border ebg-br-background-color">
			...
			<div class="ebg-br-col ebg-br-col-main">
				<p class="ebg-br-title">
					<strong>
						<a target="_blank" rel="noopener noreferrer" href="%%_DATA_USER_HTML_URL_%%">
							%%_DATA_USER_NAME_%%<span class="ebg-br-editmode"> (%%_DATA_USER_ID_%%)</span> <i class="fas fa-link"></i>
					...
					<em>
						<?php echo esc_html__( 'by', 'embed-block-for-github' ); ?><a target="_blank" rel="noopener noreferrer" href="%%_DATA_USER_HTML_URL_%%">
							%%_DATA_USER_LOGIN_%% <i class="fas fa-link"></i>
							<span class="screen-reader-text">(<?php echo esc_html__( 'this link opens in a new window', 'embed-block-for-github' ); ?>)</span>
						</a>
					</em>
				</p>
				...
				<p class="ebg-br-footer">
					...
					<div class="ebg-br-box-ul">
						<ul>
							<li class="%%_CUSTOM_DATA_USER_CREATED_AT_ONLY_DATE_%_CLASS_HIDE_IS_NULL_%%"><i class="ebg-br-icon fas fa-clock">&nbsp;</i>%%_CUSTOM_DATA_USER_CREATED_AT_ONLY_DATE_%%</li>
							<li class="%%_DATA_USER_COMPANY_%_CLASS_HIDE_IS_NULL_%%"><i class="ebg-br-icon fas fa-building">&nbsp;</i>%%_DATA_USER_COMPANY_%%</li>
							<li class="%%_DATA_USER_LOCATION_%_CLASS_HIDE_IS_NULL_%%"><i class="ebg-br-icon fas fa-map-marker-alt">&nbsp;</i>%%_DATA_USER_LOCATION_%%</li>
							<li class="%%_DATA_USER_BLOG_%_CLASS_HIDE_IS_NULL_%%">
								<i class="ebg-br-icon fas fa-link">&nbsp;</i>
